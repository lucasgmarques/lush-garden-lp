export default function Hero() {
  return (
    <section
      id="home"
      className="h-[70vh] lg:h-[100vh] xl:h-[90vh] bg-green-900 bg-cover bg-no-repeat bg-left"
    >
      <div className="container flex flex-col items-center justify-center h-full p-8 mx-auto">
        ...
        <p className="mb-4 lg:mb-8 text-center text-white lg:text-lg">
        ...
        <div>
          <button className="px-6 py-2 text-white transition duration-200 ease-in-out bg-green-500 rounded-md lg:text-xl hover:bg-green-500 lg:px-20">
            Book now
          </button>
        </div>
      </div>
